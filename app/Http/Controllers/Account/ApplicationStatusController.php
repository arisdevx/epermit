...
class ApplicationStatusController extends Controller
{
	public function index()
	{
		...
		$data['statuses'] = Applicant::where('user_id', Auth::guard('applicant')->user()->id)
									 ->orderBy('created_at', 'DESC')
									 ->paginate(10);

		return view('account.application.status', $data);
	}
	...
	public function viewHiking($id)
	{
		...
		return view('account.application.hiking', $data);
	}
	...
	public function viewConvenience($id)
	{
		...
		return view('account.application.convenience', compact('applicant'));
	}
	...
	public function viewOther($id)
	{
		...
		return view('account.application.other', $data);
	}
}