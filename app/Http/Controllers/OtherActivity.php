...
class OtherActivity extends Controller
{
	public function index(Request $request)
	{
		...
		return view('aktivitilain.index', $data);
	}
	...
	public function store(ActivityRequest $request)
	{
		...
		return redirect('aktiviti-lain/'. $applicant->id .'/view');
	}
	...
	public function edit($id)
	{
		...
		return view('aktivitilain.edit', $data);
	}
	...
	public function update(ActivityRequest $request, $id)
	{
		...
		return redirect('aktiviti-lain/'. $applicant->id .'/edit')->with('success', 'Anda Telah Berjaya Mengemaskini Permohonan Lain-lain Aktiviti');
	...
	public function viewActivity($id)
	{
		...
		return view('aktivitilain.review', $data);
	}
	...
	public function download($id)
	{
		...
		view()->share($data);
		$pdf = PDF::loadView('aktivitilain.download');
