...
@section('content')
	...
	<div class="card card-nav-tabs">
		...
		<div class="card-content">
			{{ Form::open(['url' => route('aktiviti-lain.store'), 'files' => true]) }}
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('category') ? ' has-error' : '') }}">
											...
											<select class="form-control selectpicker" name="category" id="category" title="Kategori" data-live-search="true" data-dropup-auto="false">
									...
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('place') ? ' has-error' : '') }}">
											...
											<select class="form-control selectpicker" name="place" id="place" title="Tempat Aktiviti" data-live-search="true" data-dropup-auto="false">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group{{ ($errors->has('participant') ? ' has-error' : '') }}">
											...
											{{-- <select class="form-control selectpicker" name="participant" id="participant" data-placeholder="Bilangan Peserta">
												<option></option>
											</select> --}}
											<input type="number" class="form-control" value="{{ request()->old('participant') }}" name="participant" id="participant">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('phone') ? ' has-error' : '') }}">
											...
											<input type="number" class="form-control" value="{{ request()->old('phone') }}" name="phone" id="phone">
											@if($errors->has('phone'))
									...
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('fax') ? ' has-error' : '') }}">
											...
											<input type="number" class="form-control" value="{{ request()->old('fax') }}" name="fax" id="fax">
											@if($errors->has('fax'))
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div style="margin-top: 0 !important" class="form-group{{ ($errors->has('postcode') ? ' has-error' : '') }}">
											...
											<input type="number" class="form-control" value="{{ request()->old('postcode') }}" name="postcode" id="postcode" data-maxsize="5">
