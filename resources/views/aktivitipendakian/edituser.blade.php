...
@section('content')
	...
	<div class="card card-nav-tabs">
		...
		<div class="card-content">
			{{ Form::open(['url' => url('aktiviti-pendakian/' . request()->segment(2) . '/' . request()->segment(3) . '/edit/update')]) }}
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('hiker_state') ? ' has-error' : '') }}">
											...
											<select class="form-control selectpicker" name="hiker_state" id="hiker_state" title="Negeri" data-live-search="true" data-dropup-auto="false" style="width: 100%">
									...
									<div class="col-md-4">
										...
										<div class="form-group{{ ($errors->has('hiker_country') ? ' has-error' : '') }}">
											...
											<select class="form-control selectpicker" name="hiker_country" id="country" title="Negara" data-live-search="true" data-dropup-auto="false" style="width: 100%">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('emergency_state') ? ' has-error' : '') }}">
											<label class="control-label">Negeri <small><i>State</i></small></label>
											<select class="form-control selectpicker" name="emergency_state" id="emergency_state" data-live-search="true" data-dropup-auto="false" title="Negeri" style="width: 100%">
												<option disabled selected value>Negeri</option>
												@foreach($states as $state)
									...
									<div class="col-md-4">
										...
										<div class="form-group{{ ($errors->has('emergency_country') ? ' has-error' : '') }}">
											<label class="control-label">Negara <small><i>Country</i></small></label>
											<select class="form-control selectpicker" name="emergency_country" id="country" data-live-search="true" data-dropup-auto="false" title="Negara" style="width: 100%">
												<option disabled selected value>Negara</option>
												@foreach($countries as $country)
