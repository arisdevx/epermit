	...
	(function($){
		...
		$(document).ready(function(){
			...
			$('body').on('change', '#state', function(){
				$.ajax({
					type: 'POST',
					url: '{{ url('tempahan-kemudahan/find-area') }}',
					data: {
						state_id: $(this).val(),
						_token: '{{ csrf_token() }}'
					},
				...
				// $.ajax({
				// 	type: 'POST',
				// 	url: '{{ url('tempahan-kemudahan/find-eco-park') }}',
				// 	data: {
				// 		state_id: $(this).val(),
				// 		_token: '{{ csrf_token() }}'
				// 	},
			...
			$('body').on('change', '#convenience_category', function(){
				...
				$.ajax({
					type: 'POST',
					url: '{{ url('tempahan-kemudahan/find-convenience-sub-category') }}',
					data: {
						state_id: $('#state').val(),
						area_id: $('#area').val(),
			...
			$('body').on('change', '#category', function(){
				$.ajax({
					type: 'POST',
					url: '{{ url('tempahan-kemudahan/find-price-type') }}',
					data: {
						state_id: $('#state').val(),
						area_id: $('#area').val(),
						ecopark_id: $('#eco_park').val(),
			...
			$('body').on('change', '#pricetype', function(){
				$.ajax({
					type: 'POST',
					url: '{{ url('tempahan-kemudahan/find-price') }}',
					data: {
						state_id: $('#state').val(),
						ecopark_id: $('#ecopark').val(),
						convenience_category_id: $('#conveniencecategory').val(),
			...
			$('body').on('click', '#add_convenience', function(){
				...
				$.ajax({
					type: 'POST',
					url: '{{ url('tempahan-kemudahan/set-convenience') }}',
					data: {
						state_id: $('#state').val(),
						ecopark_id: $('#ecopark').val(),
						convenience_category_id: $('#conveniencecategory').val(),
			...
			$('body').on('change', '#area', function(){
				...
				$.ajax({
					type: 'POST',
					url: '{{ url('tempahan-kemudahan/get-convenience-category') }}',
					data: {
						state_id: state_id,
						area_id: area_id,
						_token: '{{ csrf_token() }}'
			...
			$('body').on('change', '#eco_park', function(){
				...
				$.ajax({
					type: 'POST',
					url: '{{ url('tempahan-kemudahan/get-convenience') }}',
					data: {
						state_id: state_id,
						area_id: area_id,
						type: type,
			...
			$('body').on('click', '#addToTable', function(){
				...
				$.ajax({
					type: 'POST',
					url: '{{ url('tempahan-kemudahan/ajax-store') }}',
					data: {
						_token: '{{ csrf_token() }}',
						state: $('#state').val(),
						area: $('#area').val(),
			...
			$('body').on('click', '.deleteFromTable', function(){
				$.ajax({
					type: 'POST',
					url: '{{ url('tempahan-kemudahan/delete-from-table') }}',
					data: {
						_token: '{{ csrf_token() }}',
						id: $(this).data('id')
					},
