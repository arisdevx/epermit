...
@php($route = isset($category->id) ? route('capacity-category.update', $category->id) : route('capacity-category.store'))
@php($index = route('capacity-category.index'))

{!! Form::model($category, ['url' => $route, 'method' => $method, 'id' => 'capacity-category-form']) !!}
