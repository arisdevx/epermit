...
@section('content')
	...
	<div class="card card-nav-tabs">
		...
		<div class="card-content">
			{{ Form::open(['url' => url('account/member-tempahan-kemudahan/update2/' . request()->segment(4))]) }}
					...
					<div id="form2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
						<div class="panel-body">
							...
							<div class="form-group{{ ($errors->has('declaration_ic') ? ' has-error' : '') }}">
								...
								<input type="text" class="form-control" value="{{ Auth::guard('applicant')->user()->name }}" id="declaration_ic" name="declaration_ic" readonly>
