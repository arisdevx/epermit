...
<div class="row">
    ...
    <div class="card card-nav-tabs">
        <div class="card-header" data-background-color="green">
            <h4 class="title"><strong>Aktiviti Pendakian</strong></h4>
            <p class="category"><strong><i>Hiking Activities</i></strong></p>
        </div>
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <div class="col-md-6">
                        <div class="pull-right">
                            <a href="{{ url('account/member-aktiviti-pendakian/download/'. request()->segment(4)) }}" class="btn btn-success"><i class="material-icons">file_download</i></a><br />
