...
@section('content')
	...
	<div class="card card-nav-tabs">
		...
		<div class="card-content">
			{{ Form::open(['url' => route('member-aktiviti-lain.update', $applicant->id), 'method' => 'PUT', 'files' => true]) }}
								...
								<div class="row">
									<div class="col-md-5">
										<div class="form-group{{ ($errors->has('participant') ? ' has-error' : '') }}">
											...
											<input type="text" class="form-control" value="{{ (!empty($other->applicant_other_activity_detail->participant) ? $other->applicant_other_activity_detail->participant : '') }}" name="participant" id="participant">
									...
									<div class="col-md-5">
										<div class="form-group{{ ($errors->has('day') ? ' has-error' : '') }}">
											...
											<input type="text" class="form-control" value="{{ (!empty($other->applicant_other_activity_detail->day) ? $other->applicant_other_activity_detail->day : '') }}" name="day" id="day" readonly>
											@if($errors->has('day'))
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group{{ ($errors->has('name') ? ' has-error' : '') }}">
											...
											<input type="text" class="form-control" name="name" id="name" value="{{ (!empty($other->applicant_other_activity_detail->name) ? $other->applicant_other_activity_detail->name : '') }}">
											@if($errors->has('name'))
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('phone') ? ' has-error' : '') }}">
											...
											<input type="text" class="form-control" value="{{ (!empty($other->applicant_other_activity_detail->phone) ? $other->applicant_other_activity_detail->phone : '') }}" name="phone" id="phone">
											@if($errors->has('phone'))
									...
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('email') ? ' has-error' : '') }}">
											...
											<input type="text" class="form-control" value="{{ (!empty($other->applicant_other_activity_detail->email) ? $other->applicant_other_activity_detail->email : '') }}" name="email" id="email">
											@if($errors->has('email'))
									...
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('fax') ? ' has-error' : '') }}">
											...
											<input type="text" class="form-control" value="{{ (!empty($other->applicant_other_activity_detail->fax) ? $other->applicant_other_activity_detail->fax : '') }}" name="fax" id="fax">
											@if($errors->has('fax'))
								...
								<div class="row">
									<div class="col-md-7">
										<div class="form-group{{ ($errors->has('address') ? ' has-error' : '') }}">
											...
											<textarea class="form-control" rows="6" name="address">{{ (!empty($other->applicant_other_activity_detail->address) ? $other->applicant_other_activity_detail->address : '') }}</textarea>
											@if($errors->has('address'))
												<span class="help-error">{{ $errors->first('address') }}</span>
											@endif
										</div>
										<div class="form-group{{ ($errors->has('postcode') ? ' has-error' : '') }}">
											<label class="control-label" style="margin-top: 0px">Poskod <small><i>Postcode</i></small></label>
											<input type="text" class="form-control" value="{{ (!empty($other->applicant_other_activity_detail->postcode) ? $other->applicant_other_activity_detail->postcode : '') }}" name="postcode" id="postcode">
