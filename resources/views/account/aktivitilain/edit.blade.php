								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group{{ ($errors->has('state') ? ' has-error' : '') }}">
											...
											<select class="selectpicker" title="Negeri" name="state" id="state" data-live-search="true" data-dropup-auto="false">
									...
									<div class="col-md-6">
										<div class="form-group{{ ($errors->has('area') ? ' has-error' : '') }}">
											...
											<select class="selectpicker" title="Daerah" name="area" id="area" data-live-search="true" data-dropup-auto="false">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('category') ? ' has-error' : '') }}">
											...
											<select class="selectpicker" title="Kategori" name="category" id="category" data-live-search="true" data-dropup-auto="false">
									...
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('place') ? ' has-error' : '') }}">
											...
											<select class="selectpicker" title="Tempat Aktiviti" name="place" id="place" data-live-search="true" data-dropup-auto="false">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group{{ ($errors->has('participant') ? ' has-error' : '') }}">
											...
											<input type="number" class="form-control" value="{{ (!empty($other->applicant_other_activity_detail->participant) ? $other->applicant_other_activity_detail->participant : '') }}" name="participant" id="participant" min="0">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('phone') ? ' has-error' : '') }}">
											...
											<input type="number" class="form-control" value="{{ (!empty($other->applicant_other_activity_detail->phone) ? $other->applicant_other_activity_detail->phone : '') }}" name="phone" id="phone" data-maxsize="15">
											@if($errors->has('phone'))
									...
									<div class="col-md-4">
										<div class="form-group{{ ($errors->has('fax') ? ' has-error' : '') }}">
											...
											<input type="number" class="form-control" value="{{ (!empty($other->applicant_other_activity_detail->fax) ? $other->applicant_other_activity_detail->fax : '') }}" name="fax" id="fax" data-maxsize="15">
											@if($errors->has('fax'))
