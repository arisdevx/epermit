...
@section('content')
	...
	<div class="card card-nav-tabs">
		...
		<div class="card-content">
			{{ Form::open(['url' => url('tempahan-kemudahan/save')]) }}
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group{{ ($errors->has('state') ? ' has-error' : '') }}">
										...
										<select class="form-control selectpicker" name="state" id="state" data-live-search="true" data-dropup-auto="false">
								...
								<div class="col-md-6">
									<div class="form-group{{ ($errors->has('area') ? ' has-error' : '') }}">
										...
										<select class="form-control selectpicker" name="area" id="area" data-live-search="true" data-dropup-auto="false" title="Daerah">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group{{ ($errors->has('type') ? ' has-error' : '') }}">
										...
										<select class="form-control selectpicker" name="type" id="type" data-live-search="true" data-dropup-auto="false" title="TER/HTN">
								...
								<div class="col-md-6">
									<div class="form-group{{ ($errors->has('eco_park') ? ' has-error' : '') }}">
										...
										<select class="form-control selectpicker" name="eco_park" id="eco_park" data-live-search="true" data-dropup-auto="false" title="Nama TER/HTN">
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group{{ ($errors->has('day') ? ' has-error' : '') }}">
										...
										<input type="text" class="form-control" id="day" name="day" value="{{ request()->old('day') }}">
										@if($errors->has('day'))
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group{{ ($errors->has('convenience_category') ? ' has-error' : '') }}">
										...
										<select class="form-control selectpicker" name="convenience_category" id="convenience_category" data-live-search="true" data-dropup-auto="false" title="Jenis Kemudahan">
									...
									<div id="peopledetail" style="display: none">
										...
										<div class="form-group">
											...
											<select class="form-control selectpicker" name="children" id="children" title="Kanak-kanak" data-live-search="true" data-dropup-auto="false" style="width: 100%">
										...
										<div class="form-group">
											...
											<select class="form-control selectpicker" name="student" id="student" title="Pelajar" data-live-search="true" data-dropup-auto="false" style="width: 100%">
										...
										<div class="form-group">
											...
											<select class="form-control selectpicker" name="adult" id="adult" title="Dewasa" data-live-search="true" data-dropup-auto="false" style="width: 100%">
									...
									<div id="unitdetail" style="display: none">
										<div class="form-group">
											...
											<select class="form-control selectpicker" name="unit" id="unit" title="Unit" data-live-search="true" data-dropup-auto="false" style="width: 100%">
												<option></option>
											</select>
								...
								<div class="col-md-6">
									<div id="unitdata" style="display: none">
										<div class="form-group{{ ($errors->has('category') ? ' has-error' : '') }}">
											...
											<select class="form-control selectpicker" name="category" id="category" title="Kategori" data-live-search="true" data-dropup-auto="false" style="width: 100%">
												<option></option>
											</select>
									...
									<div id="people" style="display: none">
										<div class="form-group{{ ($errors->has('nationality') ? ' has-error' : '') }}">
											...
											<select class="form-control selectpicker" name="nationality" id="nationality" title="Warganegara" data-live-search="true" data-dropup-auto="false" style="width: 100%">
					...
					<div id="form2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
						<div class="panel-body">
							...
							<div class="form-group{{ ($errors->has('declaration_ic') ? ' has-error' : '') }}">
								...
								<input type="text" class="form-control" value="{{ (auth()->user()->profile->citizen == '1' ? auth()->user()->profile->nokp : auth()->user()->profile->passport) }}" id="declaration_ic" name="declaration_ic" readonly>
