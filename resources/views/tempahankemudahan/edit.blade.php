...
@section('content')
	...
	<div class="card card-nav-tabs">
		...
		<div class="card-content">
			{{ Form::open(['url' => url('tempahan-kemudahan/save-update/' . request()->segment(2))]) }}
			{{-- {{ dd($group) }} --}}
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group{{ ($errors->has('state') ? ' has-error' : '') }}">
										...
										<select class="form-control selectpicker" name="state" id="state" title="Negeri" data-live-search="true" data-dropup-auto="false">
								...
								<div class="col-md-6">
									<div class="form-group{{ ($errors->has('area') ? ' has-error' : '') }}">
										...
										<select class="form-control selectpicker" name="area" id="area" title="Daerah" data-live-search="true" data-dropup-auto="false">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group{{ ($errors->has('type') ? ' has-error' : '') }}">
										...
										<select class="form-control selectpicker" name="type" title="TER/HTN" id="type" data-live-search="true" data-dropup-auto="false">
								...
								<div class="col-md-6">
									<div class="form-group{{ ($errors->has('eco_park') ? ' has-error' : '') }}">
										...
										<select class="form-control selectpicker" name="eco_park" title="Nama TER/HTN" id="eco_park" data-live-search="true" data-dropup-auto="false">
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group{{ ($errors->has('day') ? ' has-error' : '') }}">
										...
										<input type="text" class="form-control" id="day" name="day" value="{{ ($range->days+1) }}">
										@if($errors->has('day'))
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group{{ ($errors->has('convenience_category') ? ' has-error' : '') }}">
										...
										<select class="form-control selectpicker" name="convenience_category" title="Jenis Kemudahan" id="convenience_category" data-live-search="true" data-dropup-auto="false">
									...
									<div id="unitdetail" style="display: none">
										<div class="form-group">
											...
											<select class="form-control selectpicker" name="unit" title="Unit" id="unit" data-live-search="true" data-dropup-auto="false">
												<option></option>
											</select>
								...
								<div class="col-md-6">
									<div id="unitdata" style="display: none">
										<div class="form-group{{ ($errors->has('category') ? ' has-error' : '') }}">
											...
											<select class="form-control selectpicker" name="category" title="Kategori" id="category" data-live-search="true" data-dropup-auto="false">
												<option></option>
											</select>
									...
									<div id="people" style="display: none">
										<div class="form-group{{ ($errors->has('nationality') ? ' has-error' : '') }}">
											...
											<select class="form-control selectpicker" name="nationality" title="Warganegara" id="nationality" data-live-search="true" data-dropup-auto="false">
												<option></option>
												...
												<tr id="tableId-{{ $convenience->id }}" class="row-table">
													...
													<td class="text-center">
														<div class="btn-group btn-group-sm" role="group" aria-label="...">
															<a href="{{ url('tempahan-kemudahan/edit2/' . $convenience->id) }}" class="btn btn-default"><span class="fa fa-edit"></span></a>
