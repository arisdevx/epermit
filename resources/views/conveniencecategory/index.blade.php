    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header" data-background-color="red">
                <h4 class="title pull-left">Senarai Jenis Kemudahan</h4>
                <a type="button" class="pull-right cursor-pointer"
                   data-toggle="modal"
                   data-target="#modal-form"
                   data-action="{{ route('convenience-category.create') }}"
                   data-title="Tambah"
                >
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions text-right">
                                        <a type="button" class="btn btn-primary btn-sm"
                                           data-toggle="modal"
                                           data-target="#modal-form"
                                           data-action="{{ route('convenience-category.edit', $category->id) }}"
                                        ...
                                        <a type="button" class="btn btn-danger btn-sm"
                                           ...
                                           data-action="{{ route('convenience-category.destroy', $category->id) }}"
                                           data-title="Hapus"
